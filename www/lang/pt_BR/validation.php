...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir contêm as mensagens padrão usadas pelas regras de
    | validação. Chaves ausentes aqui recaem no idioma definido em
    | APP_FALLBACK_LOCALE.
    |
    */
    ...
    'doesnt_contain' => 'O campo :attribute não deve conter nenhum de: :values.',
    ...
    */
    ...
    'attributes' => [
        'accepted_logistics_modes' => 'modalidades de logística aceitas',
        ...
        'donation_eligible' => 'aceita doação',
        'email' => 'e-mail',
        ...
        'phone' => 'telefone',
        'postal_code' => 'CEP',
        'quality_grade_id' => 'classificação de qualidade',
        'quantity' => 'quantidade',
        'registration_number' => 'número de registro',
        'role' => 'papel',
        'search' => 'busca',
        'service_regions' => 'regiões atendidas',
        'solana_wallet_address' => 'endereço da carteira Solana',
        'sort' => 'ordenação',
        'state' => 'estado',
        'status' => 'status',
        'unit' => 'unidade',
        'wallet_challenge_id' => 'desafio da carteira',
